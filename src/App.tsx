...
export const App: React.FC = () => {
  ...
  // Theme State: Default is LIGHT (false). Dark mode is opt-in (true).
  const [isDarkMode, setIsDarkMode] = useState<boolean>(() => {
    try {
      return localStorage.getItem('owl-theme') === 'dark';
    } catch {
      return false;
    }
  });
  ...
  useEffect(() => {
    if (isDarkMode) {
      ...
      try {
        localStorage.setItem('owl-theme', 'dark');
      } catch {
        // Ignore
      }
    } else {
    ...
    return (
      <div 
        style={{
          ...
          backgroundColor: isDarkMode ? '#070d1e' : '#ffffff',
      ...
      >
        ...
        <h2 style={{ fontSize: '0.85rem', color: '#1d4ed8', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '0.5rem', fontWeight: 700 }}>
          KRAKATAU POSCO
        </h2>

        <h1 style={{ fontSize: '1.6rem', color: isDarkMode ? '#ffffff' : '#0f172a', fontWeight: 800, lineHeight: 1.3, maxWidth: '300px' }}>
          ONLINE KNOWLEDGE LEARNING
        </h1>

        <div style={{ marginTop: '3rem', display: 'flex', gap: '8px' }}>
          <div style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#1d4ed8', animation: 'fadeIn 0.6s infinite alternate' }} />
          <div style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#38bdf8', animation: 'fadeIn 0.6s 0.2s infinite alternate' }} />
          <div style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#ea580c', animation: 'fadeIn 0.6s 0.4s infinite alternate' }} />
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      {currentScreen === 'home' && (
        <>
          <header style={{ paddingTop: '0.5rem', paddingBottom: '0.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div 
              style={{
                display: 'inline-flex',
                alignItems: 'center',
            ...
            >
              ...
              <span style={{ fontSize: '0.75rem', fontWeight: 700, color: isDarkMode ? '#94a3b8' : '#475569', letterSpacing: '1px' }}>
                KP-OWL LEARNING HUB
              </span>
            </div>
          ...
          <main style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '1.5rem 0', textAlign: 'center' }}>
            {/* OWL Logo - Prominent & Centered */}
            <div 
              style={{
                width: '210px',
                height: '210px',
            ...
            {/* Welcome Text */}
            <p style={{ fontSize: '1.05rem', color: isDarkMode ? '#38bdf8' : '#1d4ed8', fontWeight: 600, letterSpacing: '0.5px', marginBottom: '0.35rem' }}>
              Welcome To
            </p>
            <h1 
              style={{ 
            ...
            <p style={{ fontSize: '0.9rem', color: isDarkMode ? '#94a3b8' : '#64748b', maxWidth: '320px', lineHeight: 1.45, marginBottom: '2rem' }}>
            ...
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              >
                ...
                <span style={{ flex: 1, textAlign: 'center' }}>Click Here To Assessment</span>
              ...
              >
                <Globe size={22} style={{ color: isDarkMode ? '#38bdf8' : '#1d4ed8' }} />
                <span style={{ flex: 1, textAlign: 'center' }}>KP-OWL Website</span>
      ...
      {currentScreen === 'assessment' && (
        <>
          <header style={{ paddingTop: '0.5rem', paddingBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <span style={{ fontSize: '1.1rem', fontWeight: 700, color: isDarkMode ? '#ffffff' : '#0f172a', letterSpacing: '0.5px' }}>
              KP-OWL ASSESSMENT
            </span>
          </header>

          <main style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '1rem 0', textAlign: 'center' }}>
            <div 
              style={{
                width: '160px',
                height: '160px',
            ...
            <p style={{ fontSize: '0.88rem', color: isDarkMode ? '#94a3b8' : '#64748b', maxWidth: '320px', lineHeight: 1.4, marginBottom: '2rem' }}>
            ...
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              >
                ...
                <div style={{ flex: 1, textAlign: 'left' }}>
                  <div style={{ fontSize: '1.1rem', fontWeight: 700, color: '#ffffff' }}>Scan QR Code</div>
              ...
              >
                ...
                >
                  <Key size={26} style={{ color: '#ea580c' }} />
                </div>
                <div style={{ flex: 1, textAlign: 'left' }}>
                  <div style={{ fontSize: '1.1rem', fontWeight: 700, color: isDarkMode ? '#ffffff' : '#0f172a' }}>Enter Unique Code</div>
                  <div style={{ fontSize: '0.78rem', color: isDarkMode ? '#94a3b8' : '#64748b', fontWeight: 400 }}>
          ...
          <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
            {(scannerStatus === 'permission_denied' || scannerStatus === 'error') && (
              ...
              >
                ...
                <h3 style={{ fontSize: '1.2rem', color: isDarkMode ? '#ffffff' : '#0f172a', marginBottom: '0.5rem', fontWeight: 700 }}>
                  Akses Kamera Dibutuhkan
                </h3>
                <p style={{ fontSize: '0.88rem', color: isDarkMode ? '#94a3b8' : '#64748b', marginBottom: '1.5rem', lineHeight: 1.4 }}>
              ...
              <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div 
                  style={{
                    ...
                    boxShadow: '0 0 40px rgba(0, 0, 0, 0.8), 0 0 0 4px rgba(29, 78, 216, 0.4)',
                  }}
                >
                ...
                <p style={{ marginTop: '1.5rem', fontSize: '0.88rem', color: isDarkMode ? '#94a3b8' : '#64748b', fontWeight: 500, textAlign: 'center' }}>
